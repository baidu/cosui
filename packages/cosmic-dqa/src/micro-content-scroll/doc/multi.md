```san export=preview caption=多个内容
...
export default class DefaultDemo extends Component {
        ...
        return {
            ...
            items: [
                ...
                },
                {
                    avatar: 'https://gips0.baidu.com/it/u=1093237061,3929050000&fm=3028&app=3028&f=PNG&fmt=auto&q=75&size=f670_792',
                    author: '爱吃狼牙的土豆',
                    content: '内容内容内容内容内容内容内容内容内容内容内内容内容内容内容内容',
                    tag: '真实案例'
                },
                {
                    avatar: 'https://gips0.baidu.com/it/u=1093237061,3929050000&fm=3028&app=3028&f=PNG&fmt=auto&q=75&size=f670_792',
                    author: '爱吃狼牙的土豆',
                    content: '内容内容内容内容内容内容内容内容内容内容内内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内容内内容内容内容内容内容内容内容内容内容',
                }
            ],
            span: 8,
        }
    ...
    handleClickItem({event, item}) {
        console.log('handleClickItem', event, item);
    }
}
```