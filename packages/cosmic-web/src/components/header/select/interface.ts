...
export type TOption = Component<OptionState, OptionProps>;
export type TOptGroup = Component<OptGroupState, OptGroupProps>;
export type TOptions = TOption[];
export type TOptionGroups = Array<{
    group: TOptGroup;
    options: TOptions;
}>;
...
export type InputProps = Partial<InputData>;

export type InputState = InputData;
...
export type SingleSelectorState = Required<SingleSelectorProps>;
...
export type MultipleSelectorState = Required<MultipleSelectorProps>;
...
export type SelectorState = Required<SelectorProps>;
